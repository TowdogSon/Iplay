...
SWIFT_MODULE_NAMESPACE_PUSH("Iplay")
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC5Iplay22KTSecondViewController")
...
SWIFT_CLASS("_TtC5Iplay21KTSwiftViewController")
@interface KTSwiftViewController : UIViewController
- (void)viewDidLoad;
