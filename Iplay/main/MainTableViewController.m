...
{
    if (_itemArr==nil) {
        _itemArr= @[@"SDWebImage 异步加载图片",@"录制音频练习",@"coreData 实操+Swift-OC 互相调用",@"JS调用 OC方法",@"支付宝之给我1分钱",@"JSPatch 测试热修复",@"本地存储图片两种方式",@"动画学习练习",@"YYModel 转化"];
    }
    return _itemArr;
}
...
{
    if (_VCArr==nil) {
  _VCArr=@[@"ViewController",@"AudioViewController",@"CoreDataViewController",@"JSViewController",@"KTAlipayViewController",@"JSPatchViewController",@"KTStoreImageViewController",@"kTAnimationsViewController",@"KTTestModelViewController"];
    }
    return _VCArr;
}
- (void)viewDidLoad {
